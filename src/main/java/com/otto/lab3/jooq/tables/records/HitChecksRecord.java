...
public class HitChecksRecord extends UpdatableRecordImpl<HitChecksRecord> implements Record8<Integer, String, Double, Double, Double, OffsetDateTime, Long, Boolean> {
    ...
    @Override
    public HitChecksRecord values(Integer value1, String value2, Double value3, Double value4, Double value5, OffsetDateTime value6, Long value7, Boolean value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HitChecksRecord(Integer id, String sessionId, Double x, Double y, Double r, OffsetDateTime callingDate, Long executionTime, Boolean hitStatus) {
        super(HitChecks.HIT_CHECKS);
